...
private object Day14 : Day2021<Day14.Input>(dayNum = 14) {
    ...
    class Day14Part1 : CommonPartTest(
        exampleResult = "1588",
        taskResult = "3259",
    ) {
    ...
    class Day14Part2 : CommonPartTest(
    ...
    data class Input(
        ...
        val lastChar: Char = polymerTemplate.last()
    )
